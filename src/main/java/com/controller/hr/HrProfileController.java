...
public class HrProfileController {
    ...
    public boolean checkUserExisting(UserDetail userDetail,Model model){
        ...
        if(userDetail1.getIdUserDetails()!=userDetail.getIdUserDetails()&&(userDetail1.getEmail().equals(userDetail1.getEmail())||userDetail1.getPhone().equals(userDetail.getPhone()))){
    ...
    public boolean checkPassword(UserDetail user, Model model){
